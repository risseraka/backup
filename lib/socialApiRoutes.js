    ...
    app.get(
        ...
        function (req, res, next) {
            try {
                ...
                return next(new Error('Could not access to user\'s facebook authentication tokens'));
            }
    ...
    app.get(
        ...
        function (req, res, next) {
            try {
                ...
                return next(new Error('Could not access to user\'s twitter authentication tokens'));
            }
    ...
    app.get(
        ...
        function (req, res, next) {
            ...
            try {
                ...
                return next(new Error('Could not access to user\'s google authentication tokens'));
            }
